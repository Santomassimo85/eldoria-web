    ...
    <div className="cine-page am-page cine-compact" style={{ "--cine-accent": "#8a0e0e", "--cine-accent-2": "#c0392b" }}>
      ...
      <div className="am-how am-class-manual">
        ...
        <ul className="am-how-list" style={{ marginBottom: "12px" }}>
          ...
          <li>✨ <strong>Incantesimi</strong>: si aggiungono alle tue azioni con le loro cariche, anche fuori dalla tua classe. <strong>Comprando la spell ottieni automaticamente lo slot del suo livello</strong>: puoi lanciarla anche se è di livello alto. ⚠️ <strong>Ogni spell di livello 3 o superiore</strong> che possiedi riduce di <strong>1 per ogni livello</strong> gli incantesimi di classe selezionabili (es. il Mago passa a 3 trucchetti e 3 di Lv1 anziché 4).</li>
          <li>⚔️ <strong>Armi e armature</strong>: le armi comprate compaiono nella selezione <strong>Armi</strong> e contano come armi vere; le armature aggiungono CA (il bonus si vede nell'anteprima CA del loadout).</li>
