    ...
    <div className="cine-page am-page cine-compact" style={{ "--cine-accent": "#8a0e0e", "--cine-accent-2": "#c0392b" }}>
      ...
      <div className="am-how am-class-manual">
        ...
        <ul className="am-how-list" style={{ marginBottom: "12px" }}>
          ...
          <li>📜 <strong>Spell Scroll</strong>: sono pergamene magiche con un numero di <strong>cariche</strong> e una <strong>caratteristica</strong> per usarle (decise dal Master). Le equipaggi dalla tab <strong>Magie</strong> e le lanci anche se di livello alto. ⚠️ Alcuni scroll, per essere equipaggiati, ti fanno <strong>rinunciare a degli spell slot di classe</strong> (es. −1 slot di Lv2 e −1 di Lv3): lo vedi scritto sulla carta.</li>
