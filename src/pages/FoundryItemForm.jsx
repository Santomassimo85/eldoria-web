...
import { PROFESSIONI, tierByKey } from "../data/crafting";
          ...
          {pending.map(p => (
            <div className="dmt-li" key={p.id}>
              <div className="n">
                ...
                {/* ☠ 1 naturale: l'oggetto è maledetto e il giocatore non lo sa.
                    La maledizione NON sta nella descrizione che va su Foundry:
                    l'effetto lo applichi tu al tavolo. */}
                {p.craft?.cursed && <span className="npcgen-chip dmt-pill fdy-cursed" title={p.craft.curse ? `${p.craft.curse.nome}: ${p.craft.curse.meccanica}` : "1 naturale"}>☠ maledetto</span>}
              </div>
              <div className="d">
