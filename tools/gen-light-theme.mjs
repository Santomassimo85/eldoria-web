...
const MAP = {
  ...
  "24244a": { surf: "#e3dffa" },
  "2c2c55": { surf: "#d9d3f5" },
  // scala di superfici 2026-09-07 (S1..S4 + filo)
  "110e1b": { surf: "#f4f1ff" },
  "14111f": { surf: "#f3f0fc" },
  "201c2f": { surf: "#ffffff" },
  "2d2841": { surf: "#f7f5ff" },
  ...
  "a6a1c2": { surf: "#5d5a86", text: "#5d5a86" },
  "7a75a0": { surf: "#8d89b5", text: "#8d89b5" },
  "d6d2e6": { surf: "#2c2850", text: "#2c2850" },
  "d9d5ea": { surf: "#2c2850", text: "#2c2850" },
  "f3f0fa": { surf: "#1a1636", text: "#1a1636" },
